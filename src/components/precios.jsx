...
export default function Precios() {
  return (
    ...
    >
      {/* contenedor */}
      <div
        className="mx-auto max-w-7xl xl:max-w-[95rem] 2xl:max-w-[110rem]
      ...
      >
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h2
            className="mt-4 text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight
                       xl:[font-size:clamp(2.5rem,3vw,3.25rem)]
          ...
          <p
            className="mt-3 text-slate-600 text-sm sm:text-base
                       xl:[font-size:clamp(1rem,1.1vw,1.125rem)]
        ...
        >
          {/* Básico */}
          <div className="relative flex flex-col rounded-xl bg-white p-6 sm:p-8 xl:p-10
            ...
            <div className="flex items-end gap-2">
              <p
                className="text-3xl sm:text-4xl xl:[font-size:clamp(2.25rem,2.6vw,2.75rem)]
            ...
            <button
              className="mt-8 w-full rounded-xl py-3.5 xl:py-4
                         ...
                         font-semibold text-white shadow-md transition hover:-translate-y-[1px]"
              style={{
          ...
          <div className="relative flex flex-col rounded-xl bg-white p-6 sm:p-8 xl:p-10
                          [@media(min-width:1920px)]:p-12 [@media(min-width:2560px)]:p-14
                          shadow-md hover:shadow-lg transition border border-[#5B6FCF]/30
                          min-h-[26rem] xl:min-h-[28rem]
                          [@media(min-width:1920px)]:min-h-[30rem] [@media(min-width:2560px)]:min-h-[34rem]">
            ...
            <div className="flex items-end gap-2">
              <p
                className="text-3xl sm:text-4xl xl:[font-size:clamp(2.25rem,2.6vw,2.9rem)]
            ...
            <div className="mt-auto">
              <button
                className="mt-8 w-full rounded-xl py-3.5 xl:py-4
                           [@media(min-width:1920px)]:py-5 [@media(min-width:2560px)]:py-6
                           font-semibold text-white transition hover:-translate-y-[1px]"
                style={{
                  background: "linear-gradient(90deg, #4B007D 0%, #5B6FCF 100%)",
          ...
          <div className="relative flex flex-col rounded-xl bg-white p-6 sm:p-8 xl:p-10
            ...
            <div className="flex items-end gap-2">
              <p
                className="text-2xl sm:text-3xl lg:text-4xl xl:[font-size:clamp(2rem,2.2vw,2.5rem)]
        ...
        {/* Nota */}
        <p
          className="mt-8 sm:mt-10 text-center text-xs sm:text-sm text-slate-500
                     xl:[font-size:clamp(0.8rem,0.9vw,0.95rem)]
